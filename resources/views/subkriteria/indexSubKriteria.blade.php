            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <a href="#tambah{{ $subkriteria->id }}" data-toggle="modal" class="btn btn-sm btn-primary">
                            Tambah Sub kriteria </a>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('storeSubKriteria', $subkriteria) }}" method="post">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="tambah" class="btn btn-sm btn-success"><i
                                            class="fa fa-save"></i>
                                        Simpan</button>
                                </div>
                            </form>
